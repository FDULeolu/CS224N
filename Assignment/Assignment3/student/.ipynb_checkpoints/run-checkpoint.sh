...
if [ "$1" = "train" ]; then
	python run.py train --train-src=./zh_en_data/train.zh --train-tgt=./zh_en_data/train.en --dev-src=./zh_en_data/dev.zh --dev-tgt=./zh_en_data/dev.en --vocab=vocab.json --mps --lr=5e-4 --patience=1 --valid-niter=200 --batch-size=256 --dropout=.3
elif [ "$1" = "test" ]; then
